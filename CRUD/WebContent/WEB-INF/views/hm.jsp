			...
			<div class="col-md-2" style="position:absolute; top:30%; transfrom:translate(0%, -30%);">
				...
				<div class="card text-center">
					<div class="card-body">
						...
						<form action="edit?user=<%=userS %>&day=<%=dayS %>&workout=<%=workoutS %>" method="post">
							<div>
							   <input  name="replace" id="replace" class="form-control" value="<%=workoutS %>" class="rounded">
							</div>
							<div>
						...
						<form action="del?user=<%=userS %>&day=<%=dayS %>&workout=<%=workoutS %>" method="post">
							<div>
